...
rfc_evaluator = MulticlassClassificationEvaluator( labelCol='tasty', predictionCol="prediction", metricName="accuracy")
rfc_f1 = rfc_evaluator.evaluate(rfc_preds)
print("accuracy on RFC = %g" % rfc_f1)
rfc_evaluator1 = MulticlassClassificationEvaluator( labelCol='tasty', predictionCol="prediction", metricName="f1")
rfc_f2 = rfc_evaluator1.evaluate(rfc_preds)
print("f-score on RFC = %g" % rfc_f2)
