...
df = spark.read.csv('/home/ec2-user/TrainingDataset.csv',header='true', inferSchema='true', sep=';')
...
df_test = spark.read.csv('/home/ec2-user/ValidationDataset.csv',header='true', inferSchema='true', sep=';')
...
gbt_evaluator = MulticlassClassificationEvaluator(    labelCol='tasty', predictionCol="prediction", metricName="f1")
...
dt_evaluator1 = MulticlassClassificationEvaluator(
    labelCol='tasty', predictionCol="prediction", metricName="accuracy")
dt_f2 = dt_evaluator1.evaluate(dt_preds)
print("Accuracy on DT = %g" % dt_f2)
